...
v1=$(curl -sSL "https://raw.githubusercontent.com/kevindoni/PANEL-VPS/master/versaoatt")
...
echo -e "\033[1;36mwget https://raw.githubusercontent.com/kevindoni/PANEL-VPS/master/Install/apt-source.sh && chmod 777 ./* && ./apt-*"
echo -e "$barra"
echo -ne "\033[0m"
exit 1
}
...
echo -e "$barra"
echo -e "${cor[5]} $(source trans -b pt:${id} "INSTALLER SCRIPTS") ®"
echo -e "$barra"
